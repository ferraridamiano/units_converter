...
void main() {
  ...
  var length =
      Length(removeTrailingZeros: false); //initialize Length object, let's specify that we want to keep the trailing zeros (e.g. 1.000) for stringValue
  ...
  customConversion.Convert(Unit('EUR', value: 1));
